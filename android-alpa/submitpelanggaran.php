...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
    ...
    if ( $tanggal_pelanggaran == '' || $siswa_id == '' || $pelanggaran_id == '' || $user_id == '' ){
        ...
        $query = "INSERT INTO `catatan_poin_pelanggaran`(`tanggal_pelanggaran`, `siswa_id`, `pelanggaran_id`, `user_id`) VALUES ('$tanggal_pelanggaran','$siswa_id','$pelanggaran_id','$user_id')";

        if ( mysqli_query($conn, $query) ){

            if ($bukti == null) {
                $finalPath = "/android-alpa/default.png"; 
                $response["value"] = "1";
