                    ...
                    <select class="form-control-sm" id="sel1" name="jurusan_id">
                        <option value="">Kode Jurusan</option>
                            ...
                            <?php
                                ...
                                WHERE kelas.user_id='$user_id' AND jurusan.status_jurusan=1
            ...
            <table class="table table-bordered zero-configuration">
                ...
                <tbody>
                    <?php
                        ...
                        WHERE kelas.tingkat_kelas LIKE ? AND kelas.tipe_kelas LIKE ? AND jurusan.jurusan_id LIKE ? AND kelas.user_id='$user_id' AND siswa.status_siswa=1
                        ORDER BY siswa.poin_pelanggaran_siswa DESC";
                                                ...
                                                ?>
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <a class="btn mb-1 btn-sm fa fa-print" style="color:#000; background-color: #ffd2d2;" href="<?php echo BASE_URL."export-pelanggaran-siswa.php?siswa_id=$siswa_id&poin=$poin"; ?>" target="_blank"> Cetak Catatan Pelanggaran</a>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <a class="btn mb-1 btn-sm fa fa-print" style="color:#000; background-color: #d8d7fd;" href="<?php echo BASE_URL."export-prestasi-siswa.php?siswa_id=$siswa_id&poin=$poin"; ?>" target="_blank"> Cetak Catatan Prestasi</a>
                                                        </div>                                                        
                                                    </form>
                                                </div>
