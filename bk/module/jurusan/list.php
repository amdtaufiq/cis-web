    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover zero-configuration">
            <thead>
                <tr>
                    <th width="20px">No</th>
                    <th width="100px">Kode Jurusan</th>
                    <th>Nama Jurusan</th>                           
    ...
    <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Input Data Jurusan</h5>
                ...
                <form id="formTambah">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" autocomplete="off">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formUbah">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Kode Jurusan</label>
                                <input type="text" class="form-control" id="kode_jurusan1" name="kode_jurusan1" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Nama Jurusan</label>
                                <input type="text" class="form-control" id="nama_jurusan1" name="nama_jurusan1" autocomplete="off">
                            </div>
