<div class="card-body">
    <h4 class="card-title">Tambah Catatan Pelanggaran</h4><hr>
    <div class="basic-form">
      <form action="index.php?page=catatan-pelanggaran-form" method="post" class="form-inline p-3 align-middle">
