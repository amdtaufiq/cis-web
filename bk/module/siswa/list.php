                ...
                <div class="modal-dialog" role = "document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success text-white" data-dismiss="modal">Batal</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <table class="table table-striped table-hover table-bordered zero-configuration">
            <thead>
                <tr class="text-center">
                    <th width="20px">No</th>
                    <th width="50px">Poin Pelanggaran</th>
                    <th width="50px">Poin Prestasi</th>
                    <th>Nama Siswa</th>                          
                    ...
                    if($res->num_rows > 0){
                        while ($row = $res->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $poin_pelanggaran_siswa; ?></td>
                                <td class="text-center"><?php echo $poin_prestasi_siswa; ?></td>
            ...
            <div class="modal-content">
                ...
                <form id="formTambah">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Poin Pelanggaran Siswa</label>
                            <input type="text" class="form-control" id="poin_pelanggaran_siswa" name="poin_pelanggaran_siswa" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label>Poin Prestasi Siswa</label>
                            <input type="text" class="form-control" id="poin_prestasi_siswa" name="poin_prestasi_siswa" autocomplete="off">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formUbah">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Poin Pelanggaran Siswa</label>
                                <input type="text" class="form-control" id="poin_pelanggaran_siswa1" name="poin_pelanggaran_siswa1" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Poin Prestasi Siswa</label>
                                <input type="text" class="form-control" id="poin_prestasi_siswa1" name="poin_prestasi_siswa1" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Nama Siswa</label>
                                <input type="text" class="form-control" id="nama_siswa1" name="nama_siswa1" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Nomor Induk Siswa (NIS)</label>
                                <input type="text" class="form-control" id="nis1" name="nis1" autocomplete="off">
                            </div>
...
<script type="text/javascript">
    ...
    document.getElementById('btnSimpan').addEventListener("click", function(){
        ...
        else if ($('#poin_prestasi_siswa').val()==""){
            $( "#poin_prestasi_siswa" ).focus();
            swal("Peringatan!", "Poin prestasi siswa tidak boleh kosong", "warning");
        } 
    ...
    userSelection[i].addEventListener("click", function() {
        ...
        $.ajax({
                    ...
                    success: function(result){
                        ...
                        $('#poin_prestasi_siswa1').val(result.poin_prestasi_siswa);
    ...
    document.getElementById('btnUbah').addEventListener("click", function(){
        ...
        else if ($('#poin_prestasi_siswa1').val()==""){
            $( "#poin_prestasi_siswa1").focus();
            swal("Peringatan!", "Poin prestasi siswa tidak boleh kosong", "warning");
        } 
                    ...
                    $.ajax({
                        ...
                        success: function(result){ 
                            ...
                            if (result==="sukses") {
                                ...
                                swal("Sukses!", "Data siswa berhasil dirubah.", "success");
                                setTimeout(() => window.location.reload(), 1000);
                            } else {
                                swal("Gagal!", "Data siswa tidak bisa dirubah.", "error");
                                setTimeout(() => window.location.reload(), 1000);
                            }
                        }
                    });
