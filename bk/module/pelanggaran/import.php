<div class="card-body">
	<a href="<?php echo BASE_URL.'index.php?page=pelanggaran-list' ?>" class="btn btn-danger btn-sm pull-right">Batal</a><br>
    <br>
    <h3>Form Impor Data</h3><hr>

    <form method="post" action="" enctype="multipart/form-data">
		<a href="<?php echo BASE_URL.'format/JENIS_PELANGGARAN.xlsx'; ?>" class="btn btn-outline-info btn-sm">Unduh Format</a><br><br>
		...
		if(isset($_POST['preview'])){
			...
			if($ext == "xlsx"){
				...
				<form method='post' action="<?php echo BASE_URL."module/pelanggaran/action-import.php"; ?>">
	                ...
	                <button type='submit' name='import' class='btn btn-sm btn-primary'>Impor</button>
	                <br><br>
							...
							<?php
								...
								foreach($sheet as $row){ 
									...
									if($numrow > 1){
										...
										echo "<td".$nama_td.">".$kode_pelanggaran."</td>";
										echo "</tr>";
									}
