<?php
    ...
    $query = "SELECT siswa.*,kelas.*, jurusan.* 
             ...
             WHERE kelas.tingkat_kelas LIKE ? AND kelas.tipe_kelas LIKE ? AND jurusan.jurusan_id LIKE ? AND kelas.user_id='$user_id' AND siswa.status_siswa ORDER BY siswa.nis ASC";
