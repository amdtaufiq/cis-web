            ...
            <?php
                    ...
                    while($row=mysqli_fetch_assoc($queryjurusan)) {
                        ...
                        echo "<tr>
                            ...
                            <td>
                            <input id='".$jurusan_id."' style='margin-right:10px;' onclick='onChangeTindakan(".$jurusan_id.")' type='checkbox'"; if($row['status_jurusan'] == 1 ){echo 'checked';} echo ">";
                            if($row['status_jurusan']==1){echo "Aktif";}else{echo "Non-aktif";}
                            echo "
                            </td>
...
<script type="text/javascript">
    ...
    function onChangeTindakan(jurusan_id) {
        ...
        xhr.open('POST', './module/jurusan/update-status.php', true);
        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhr.send(`jurusan_id=${jurusan_id}`);
        ...
        if ($('#kode_jurusan').val()==""){
                    ...
                    $.ajax({
                        ...
                        success: function(result){ 
                            console.log(result);  
                            if (result==="sama") {
                                swal("Gagal!", "Kode Jurusan sudah terdaftar.", "error");
