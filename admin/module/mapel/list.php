        ...
        <table class="table table-striped table-bordered table-hover zero-configuration">
            <thead>
                <tr>
                    ...
                    <th width="13%" class="text-center">Kode Mapel</th>
                    <th width="64%" class="text-center">Nama Mata Pelajaraan</th> 
            ...
            <?php
                    ...
                    while($row=mysqli_fetch_assoc($querymapel)) {
                        ...
                        echo "<tr>
                            ...
                            <td>
                            <input id='".$mapel_id."' style='margin-right:10px;' onclick='onChangeTindakan(".$mapel_id.")' type='checkbox'"; if($row['status'] == 1 ){echo 'checked';} echo ">";
                            if($row['status']==1){echo "Aktif";}else{echo "Non-aktif";}
                            echo "
                            </td>
                            <td>
...
<script type="text/javascript">
    ...
    function onChangeTindakan(mapel_id) {
        ...
        xhr.open('POST', './module/mapel/update-status.php', true);
        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhr.send(`mapel_id=${mapel_id}`);
        ...
        if ($('#kode_mapel').val()==""){
                    ...
                    $.ajax({
                        ...
                        success: function(result){ 
                            console.log(result);                        
                            if(result==="sama"){
                                swal("Gagal!", "Kode Mapel sudah terdaftar", "error");
